...
Run: `printf '{"jsonrpc":"2.0","id":1,"method":"tools/list","params":{}}\n' | timeout 15 /root/testassist-mcp/.venv/bin/python /root/testassist-mcp/server/testassist_mcp_server.py`
Expected: a JSON response whose `result.tools` array contains 5 tools.
